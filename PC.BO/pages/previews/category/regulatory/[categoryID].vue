...
@NuxtComponent({
  name: 'preview-category-regulatory-screen',
  components: {
    // COMPONENTS CUSTOM APP
  }
})
class PreviewCategoryRegulatoryScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
...
export default PreviewCategoryRegulatoryScreen;
</script>
  ...
  <v-row justify="center" align-content="center" no-gutters>
    ...
    <v-col cols="12">
      <v-img width="100%" height="500"
        :src="$vuetify.display.mdAndDown ? category.pictures.responsive?? category.pictures.responsiveImageDetail?.image : category.pictures.banner?? category.pictures.responsiveImageDetail?.image" cover />
    </v-col>
