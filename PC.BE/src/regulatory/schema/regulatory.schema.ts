...
export type RegulatoryDocument = Regulatory & Document;
...
// SCHEMA TYPES BUSINESS
@Schema()
@ObjectType()
export class Regulatory extends Document {
  @Prop()
  @Field(() => ID)
  _id: Types.ObjectId;
...
export const RegulatorySchema = SchemaFactory.createForClass(Regulatory);
