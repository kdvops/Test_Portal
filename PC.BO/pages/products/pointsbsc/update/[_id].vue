...
@NuxtComponent({
  name: "products-pointsbsc-update-screen",
  components: {
...
class ProductsPointsBscUpdateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  public async updateProductCard() {
    ...
    try {
      ...
      // GO TO LIST
      this.$router.push("/products/cards/list");
...
export default ProductsPointsBscUpdateScreen;
</script>
...
<template>
  <v-row class="px-0 pt-10" justify="center" align-content="center">
    ...
    <v-col class="mb-10 text-center" cols="12">
      <v-btn :loading="loading" rounded="xl" :disabled="!valid || product.sections.length === 0"
        @click="updateProductCard()">Actualizar Tarjeta</v-btn>
    </v-col>
  </v-row>
</template>
