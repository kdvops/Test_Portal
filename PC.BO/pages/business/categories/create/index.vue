...
@NuxtComponent({
  name: "business-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class BusinessCategoriesCreateScreen extends Vue {
  // Instances
  public $bus: any;
  ...
  public async created() {
    ...
    const defaultKey = "categoryBusiness";
  ...
  public async goPreview() {
    ...
    this.$router.push(`/business/categories/update/${category.createCategory._id}`);

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/${"business"}/${category.createCategory._id}`,
    });
...
export default BusinessCategoriesCreateScreen;
</script>
