...
@NuxtComponent({
  name: "products-card-update-screen",
  components: {
...
class ProductsCardUpdateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
...
export default ProductsCardUpdateScreen;
</script>
...
<template>
  <v-row class="px-0 pt-10" justify="center" align-content="center">
    ...
    <v-bottom-navigation bg-color="#12539b">
      ...
      <v-btn @click="updateProductCard()" :disabled="!valid || product.sections.length === 0" :loading="loading">
        <v-icon>
          mdi-upload
        </v-icon>
