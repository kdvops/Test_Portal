...
@NuxtComponent({
  name: "products-accounts-update-screen",
  components: {
...
class ProductsAccountsUpdateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // UPDATE PRODUCT CARD
  public async updateProductAccount() {
    // SET LOADING
    this.loading = true;
...
export default ProductsAccountsUpdateScreen;
</script>
...
<template>
  <v-row class="px-0 pt-10" justify="center" align-content="center">
    ...
    <v-bottom-navigation bg-color="#12539b">
      ...
      <v-btn @click="updateProductAccount()" :disabled="!valid || product.sections.length === 0" :loading="loading">
        <v-icon>
          mdi-upload
        </v-icon>
