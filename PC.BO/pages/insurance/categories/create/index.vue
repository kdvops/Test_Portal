...
@NuxtComponent({
  name: "insurance-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class InsuranceCategoriesCreateScreen extends Vue {
  // Instances
  ...
  public async created() {
    ...
    const defaultKey = "categoryInsurance";
  ...
  public async goPreview() {
    ...
    this.$router.push(`/insurance/categories/update/${category.createCategory._id}`);

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/${"insurance"}/${category.createCategory._id}`,
    });
...
export default InsuranceCategoriesCreateScreen;
</script>
