...
@NuxtComponent({
  name: "regulatory-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class RegulatoryCategoriesCreateScreen extends Vue {
  // Instances
  public $bus: any;
  ...
  public async created() {
    ...
    const defaultKey = "categoryAboutUs";
  ...
  public async goPreview() {
    ...
    this.$router.push(`/regulatory/categories/update/${category.createCategory._id}`);

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/regulatory/category/${category.createCategory._id}`,
    });
...
export default RegulatoryCategoriesCreateScreen;
</script>
