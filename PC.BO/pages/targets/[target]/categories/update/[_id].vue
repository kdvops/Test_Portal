...
@NuxtComponent({
  name: "target-categories-update-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class TargetCategoriesUpdateScreen extends Vue {
  // GET PARAM TARGET
  ...
  // SET CATEGORIES (FOR PARENT SELECTION)
  ...
  public async goPreview() {
    ...
    const route = this.$router.resolve({
      path: `/previews/category/targets/${this.categoryID}`,
    });
...
export default TargetCategoriesUpdateScreen;
</script>
...
<template>
  <category-form-page
    ...
    :target-name="targetInfo?.name || 'Target'"
    :loading="loading"
