...
@NuxtComponent({
  name: "products-deposit-list-screen",
  components: {
...
class ProductsDepositListScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // GO TO CREATE SCREEN
  public goCreate() {
    this.$router.push("/products/deposits/create");
  }

  // GO TO UPDATE SCREEN
  public goUpdate(productID: string) {
    this.$router.push(`/products/deposits/update/${productID}`);
  }
...
export default ProductsDepositListScreen;
</script>
