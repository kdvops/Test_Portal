...
// IMPORT INTERFACE
import type { SectionTypeInterface, DialogCreateNewSectionCard, TypeCard, TableColumnSectionInterface, TypeTable } from "~/interfaces/sections.interface";
        ...
        <thead class="bg-primary">
          <tr>
            <template v-for="(header, i) in section.table.headers" :key="i" class="text-left">
              <th class="px-5 text-uppercase font-weight-bold" style="position: relative">
                {{ header }}
              </th>
            </template>
          </tr>
