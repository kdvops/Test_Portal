...
@NuxtComponent({
  name: "products-pointsbsc-list-screen",
  components: {
...
class ProductsPointsBscListScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // GO TO CREATE SCREEN
  public goCreate() {
    this.$router.push("/products/pointsbsc/create");
  }

  // GO TO UPDATE SCREEN
  public goUpdate(productID: string) {
    this.$router.push(`/products/pointsbsc/update/${productID}`);
  }
...
export default ProductsPointsBscListScreen;
</script>
