...
@NuxtComponent({
  name: "prouser-categories-update-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class ProuserCategoriesUpdateScreen extends Vue {
  // Route params
  ...
  public async created() {
    ...
    this.targetManager.selectTarget("categoryProuser");
  ...
  public async setTargetInfo() {
    try {
      ...
      this.targetInfo = {
        ...
        name: "Prouser",
        color: "#12539b",
        description: "Categorías de Prouser",
        status: "publish",
        createdAt: new Date(),
        updatedAt: new Date(),
        slug: "",
  ...
  public async updateCategory() {
    ...
    try {
      ...
      this.$router.push(`/prouser/categories/list`);
  ...
  public async goPreview() {
    ...
    const route = this.$router.resolve({
      path: `/previews/category/${"prouser"}`,
    });
...
export default ProuserCategoriesUpdateScreen;
</script>
...
<template>
  <category-form-page
    ...
    :target-name="targetInfo?.name || 'Prouser'"
    :loading="loading"
