...
@NuxtComponent({
  name: "prouser-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class ProuserCategoriesCreateScreen extends Vue {
  // Instances
  public $bus: any;
  ...
  public async created() {
    ...
    const defaultKey = "categoryProuser";
  ...
  public async goPreview() {
    ...
    this.$router.push(`/prouser/categories/update/${category.createCategory._id}`);

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/${"prouser"}/${category.createCategory._id}`,
    });
...
export default ProuserCategoriesCreateScreen;
</script>
