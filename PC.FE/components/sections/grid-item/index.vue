        ...
        >
          ...
          <template v-if="!cell.isEmpty">            
              ...
              >
                <template #prepend>
                  <IconImage
                    ...
                    :height="getItemStyleValue(cell.layout, 'size', 'medium') === 'small' ? 20 : getItemStyleValue(cell.layout, 'size', 'medium') === 'x-large' ? 34 : 28"
                  />
                </template>
            ...
            <div v-else-if="cell.layout.type === 'image'" class="grid-item-image grid-item-content">
              <CardImage
                :src="cell.layout.image?? cell.layout.imageDetail?.image?? noimage"
                :alt="cell.layout.imageDetail?.altText?? ''"
                :width="styleCards.width * cell.w"
                :height="styleCards.height * cell.h"
                container-class="grid-image-container"
              />
            </div>
