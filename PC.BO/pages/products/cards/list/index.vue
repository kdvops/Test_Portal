...
@NuxtComponent({
  name: "products-card-list-screen",
  components: {
...
class ProductsCardListScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // GO TO CREATE SCREEN
  public goCreate() {
    this.$router.push("/products/cards/create");
  }

  // GO TO UPDATE SCREEN
  public goUpdate(productID: string) {
    this.$router.push(`/products/cards/update/${productID}`);
  }
...
export default ProductsCardListScreen;
</script>
