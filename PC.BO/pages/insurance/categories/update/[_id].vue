...
@NuxtComponent({
  name: "insurance-categories-update-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class InsuranceCategoriesUpdateScreen extends Vue {
  // Route params
  ...
  public async created() {
    ...
    this.targetManager.selectTarget("categoryInsurance");
  ...
  public async setTargetInfo() {
    try {
      ...
      this.targetInfo = {
        _id: "categoryInsurance",
        name: "Insurance",
        color: "#12539b",
        description: "Categorías de Insurance",
        status: "publish",
        createdAt: new Date(),
        updatedAt: new Date(),
        slug: "",
  ...
  public async updateCategory() {
    ...
    try {
      ...
      this.$router.push(`/insurance/categories/list`);
  ...
  public async goPreview() {
    ...
    const route = this.$router.resolve({
      path: `/previews/category/${"insurance"}`,
    });
...
export default InsuranceCategoriesUpdateScreen;
</script>
...
<template>
  <category-form-page
    ...
    :target-name="targetInfo?.name || 'Insurance'"
    :loading="loading"
          ...
          <v-row>
            ...
            <v-col cols="12" md="6">
              ...
              >
                ...
                <p class="text-body-1 mb-0">
                  Las <strong>categorias</strong> organizan el contenido dentro
