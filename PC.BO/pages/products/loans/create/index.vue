...
@NuxtComponent({
  name: 'products-loans-create-screen',
  components: {
...
class ProductsLoansCreateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // CREATE PRODUCT CARD
  public async createProductLoans() {
    // SET LOADING FALSE
    this.loading = true
    ...
    try {
      ...
      // REDIRECT TO LIST
      this.$router.push('/products/loans/list')
  ...
  public async goPreview() {
    ...
    this.$router.push(`/products/loans/update/${product.createProduct._id}`)
...
export default ProductsLoansCreateScreen;
</script>
  ...
  <v-row class="px-0 pt-10" justify="center" align-content="center">
    ...
    <v-col cols="12" class="pb-15 mb-15">
     ...
     <v-bottom-navigation bg-color="#12539b">
      <v-btn @click="createProductLoans()"
