...
@NuxtComponent({
  name: "products-deposits-create-screen",
  components: {
...
class ProductsDepositsCreateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // CREATE PRODUCT CARD
  public async createProductDeposit() {
    // SET LOADING FALSE
    this.loading = true;
  ...
  public makeid(length:number) {
    ...
    this.product.sections = [
      ...
      {
        ...section,
        _id: section._id?? section._id?? this.makeid(8),
  ...
  public async goPreview() {
    ...
    this.$router.push(`/products/deposits/update/${product.createProduct._id}`)
...
export default ProductsDepositsCreateScreen;
</script>
...
<template>
  <v-row class="px-0 pt-10" justify="center" align-content="center">
    ...
    <v-bottom-navigation bg-color="#12539b">
      <v-btn @click="createProductDeposit()"
