...
@NuxtComponent({
  name: "enterprise-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class EnterpriseCategoriesCreateScreen extends Vue {
  // Instances
  ...
  public async created() {
    ...
    const defaultKey = "categoryEnterprise";
  ...
  public async goPreview() {
    ...
    this.$router.push(
      `/enterprise/categories/update/${category.createCategory._id}`
    );

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/${"enterprise"}/${category.createCategory._id}`,
    });
...
export default EnterpriseCategoriesCreateScreen;
</script>
