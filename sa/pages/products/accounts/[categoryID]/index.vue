...
<script lang="ts">
definePageMeta({
  alias: "/productos/cuentas/:categoryID",
  seoManual: true,
});
...
@NuxtComponent({
  ...
  async setup() {
    const vm = getCurrentInstance()!.proxy as ProductsAccountsScreen;
...
export default class ProductsAccountsScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
        ...
        <v-row no-gutters>
          ...
          >
            <div class="info-category-card-large-container">
              ...
              <v-btn
                width="140"
                :to="`/productos/cuentas/${pageParam}/item/${product.slug}`"
                color="primary"
