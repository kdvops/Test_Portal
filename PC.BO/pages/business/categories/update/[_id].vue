...
@NuxtComponent({
  name: "business-categories-update-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class BusinessCategoriesUpdateScreen extends Vue {
  // Route params
  ...
  public async created() {
    ...
    this.targetManager.selectTarget("categoryBusiness");
  ...
  public async setTargetInfo() {
    try {
      ...
      this.targetInfo = {
        _id: "categoryBusiness",
        name: "Business",
        color: "#12539b",
        description: "Categorías de Business",
        status: "publish",
        createdAt: new Date(),
        updatedAt: new Date(),
        slug: "",
  ...
  public async updateCategory() {
    ...
    try {
      ...
      this.$router.push(`/business/categories/list`);
  ...
  public async goPreview() {
    ...
    const route = this.$router.resolve({
      path: `/previews/category/${"business"}`,
    });
  ...
  public goUpdate(categoryID: string) {
    this.$router.push(`/business/categories/update/${categoryID}`);
  }
}
export default BusinessCategoriesUpdateScreen;
</script>
...
<template>
  <category-form-page
    ...
    :target-name="targetInfo?.name || 'Business'"
    :loading="loading"
