...
<script lang="ts">
definePageMeta({
  alias: "/productos/depositos/:categoryID",
  seoManual: true,
});
...
@NuxtComponent({
  ...
  async setup() {
    const vm = getCurrentInstance()!.proxy as ProductsDepositsScreen;
...
export default class ProductsDepositsScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
        ...
        <v-row no-gutters>
          ...
          >
            <div class="info-category-card-large-container">
              ...
              <v-btn
                width="140"
                :to="`/productos/depositos/${pageParam}/item/${product.slug}`"
                color="primary"
