...
export default class InsuranceHomeScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
...
<template>
  <v-row
    class="insurance-home-container"
    justify="center"
