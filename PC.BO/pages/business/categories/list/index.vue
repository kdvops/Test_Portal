...
@NuxtComponent({
  name: "business-categories-list-screen",
  components: {
...
class BusinessCategoriesListScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  public async setCategories() {
    try {
      await this.categoryStore.loadCategories("category::business");
  ...
  // GO TO CREATE SLIDER
  public goCreate() {
    this.$router.push(`/business/categories/create`);
  }
...
export default BusinessCategoriesListScreen;
</script>
          ...
          <v-card-text>
            <v-row align-content="center" justify="space-between">
              ...
              >
                ...
                >
                  Lista de categorías de mi negocio,
                </p>
                <p class="text-caption text-white font-weight-light ml-10">
                  Ahora puedes gestionar tus categorías de mi negocio de una
                  manera mas sencilla!
                </p>
                <v-btn
                  @click="goCreate()"
