...
<script lang="ts">
definePageMeta({
  alias: "/productos/tarjetas/:categoryID",
  seoManual: true,
});
...
@NuxtComponent({
  ...
  async setup() {
    const vm = getCurrentInstance()!.proxy as ProductsCardsScreen;
...
export default class ProductsCardsScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
        ...
        <v-row no-gutters>
          ...
          >
            <div class="info-category-card-large-container">
              ...
              <v-btn
                width="140"
                :to="`/productos/tarjetas/${pageParam}/item/${product.slug}`"
                color="primary"
