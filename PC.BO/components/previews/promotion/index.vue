...
@NuxtComponent({
  name: 'preview-app-promotion-card-component'
})
class PreviewAppPromotionCardComponent extends Vue {
  ///////////////
  //// PROPS ////
  ///////////////
...
export default PreviewAppPromotionCardComponent;
</script>
      ...
      <v-row class="my-0" align-content="center" justify="center" no-gutters>
        <v-col cols="12">
          <div style="background: #12499b;" class="promotion-card-image pa-5">
            <v-img v-if="promotion.picture" width="100%" height="100%" 
              :src="promotion.picture?? promotion.pictureImageDetail?.image" 
              :alt="promotion.pictureImageDetail?.altText?? ''" 
              contain eager />
