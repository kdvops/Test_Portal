...
@NuxtComponent({
  name: "regulatory-categories-update-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class RegulatoryCategoriesUpdateScreen extends Vue {
  // Route params
  ...
  public async created() {
    ...
    this.targetManager.selectTarget("categoryAboutUs");
  ...
  public async setTargetInfo() {
    try {
      ...
      this.targetInfo = {
        ...
        name: "Regulatory",
        color: "#12539b",
        description: "Categorías de Regulatory",
        status: "publish",
        createdAt: new Date(),
        updatedAt: new Date(),
        slug: "",
  ...
  public async updateCategory() {
    ...
    try {
      ...
      this.$router.push(`/regulatory/categories/list`);
  ...
  public async goPreview() {
    ...
    const route = this.$router.resolve({
      path: `/previews/category/${"regulatory"}`,
    });
...
export default RegulatoryCategoriesUpdateScreen;
</script>
...
<template>
  <category-form-page
    ...
    :target-name="targetInfo?.name || 'Regulatory'"
    :loading="loading"
