...
@NuxtComponent({
  name: "profits-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class ProfitsCategoriesCreateScreen extends Vue {
  // Instances
  public $bus: any;
  ...
  public async created() {
    ...
    const defaultKey = "categoryProfits";
  ...
  public async goPreview() {
    ...
    this.$router.push(`/profits/categories/update/${category.createCategory._id}`);

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/${"profits"}/${category.createCategory._id}`,
    });
...
export default ProfitsCategoriesCreateScreen;
</script>
