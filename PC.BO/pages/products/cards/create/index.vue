...
@NuxtComponent({
  name: "products-card-create-screen",
  components: {
...
class ProductsCardCreateScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  public async goPreview() {
    ...
    this.$router.push(`/products/cards/update/${product.createProduct._id}`)
...
export default ProductsCardCreateScreen;
</script>
