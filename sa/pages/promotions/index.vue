...
import { GET_PROMOTIONS_BY_DATE } from '~/graphql/promotions.query';
...
export default class PromotionsScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  public setParamsDate() {
    this.params = {
      search: "",
      start: this.$app.$moment().startOf("month").toDate(),
      end: this.$app.$moment().endOf("month").toDate(),
    };
  }
        ...
        <v-row justify="center">
          <v-col cols="10">
            <v-text-field
              ...
              @keyup.enter="getPromotionsByDate()"
              variant="solo"
              rounded="xl"
              label="Buscar"
              density="compact"
