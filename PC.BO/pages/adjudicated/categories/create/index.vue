...
@NuxtComponent({
  name: "adjudicated-categories-create-screen",
  components: {
    "category-form-page": CategoryFormPage,
  },
})
class AdjudicatedCategoriesCreateScreen extends Vue {
  // Instances
  ...
  public async created() {
    ...
    const defaultKey = "categoryAdjudicated";
  ...
  public async goPreview() {
    ...
    this.$router.push(
      `/adjudicated/categories/update/${category.createCategory._id}`
    );

    // GO PREVIEW BEFORE CREATE CATEGORY
    const route = this.$router.resolve({
      path: `/previews/category/adjudicated/${category.createCategory._id}`,
    });
...
export default AdjudicatedCategoriesCreateScreen;
</script>
