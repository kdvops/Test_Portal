...
@NuxtComponent({
  name: "products-accounts-list-screen",
  components: {
...
class ProductsAccountListScreen extends Vue {
  ///////////////
  // VARIABLES //
  ///////////////
  ...
  // GO TO CREATE SCREEN
  public goCreate() {
    this.$router.push("/products/accounts/create");
  }

  // GO TO UPDATE SCREEN
  public goUpdate(productID: string) {
    this.$router.push(`/products/accounts/update/${productID}`);
  }
...
export default ProductsAccountListScreen;
</script>
